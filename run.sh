...
#测试Bert-bilstm-crf
python3 main.py --algorithm="bilstm-crf" --data-set="clue" --min-freq=10 --test --test-model-path="/checkpoints/clue/bilstm-crf-bert/epoch_164.pth" --use-bert --embedding-size=768  --hidden-size=200 --num-layers=2 --bert-model-dir="/bert/bert-base-chinese" --use-norm
python3 main.py --algorithm="bilstm-crf" --data-set="msra" --min-freq=10 --test --test-model-path="/checkpoints/clue/bilstm-crf-bert/epoch_10.pth" --use-bert --embedding-size=768  --hidden-size=200 --num-layers=2 --bert-model-dir="/bert/bert-base-chinese" --use-norm
