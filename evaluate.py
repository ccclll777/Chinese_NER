...
class ConfusionMatrix(object):
    ...
    def get_precision(self):
        ...
        for tag in self.tag_set:
            precision_scores[tag] = self.correct_tags_count.get(tag, 0) /  self.predict_tags_count[tag]
    ...
    def get_recall(self):
        ...
        recall_scores = {}
        for tag in self.tag_set:
            recall_scores[tag] = self.correct_tags_count.get(tag, 0) / self.tags_count[tag]
